...
public class JobSeekerSaveController {
  ...
  public JobSeekerSaveController(UserService userService, JobSeekerProfileService jobSeekerProfileService, JobPostActivityService jobPostActivityService,
  ...
  public String save(@PathVariable("id") int id, JobSeekerSave jobSeekerSave) {
    ...
    if (!(authentication instanceof AnonymousAuthenticationToken)) {
      ...
      User user  = userService.findByEmail(currenUsername);
      Optional<JobSeekerProfile> seekerProfile = jobSeekerProfileService.getOne(user.getUserId());
      JobPostActivity jobPostActivity = jobPostActivityService.getOne(id);

      if (seekerProfile.isPresent() && jobPostActivity != null) {
        jobSeekerSave.setJob(jobPostActivity);
        jobSeekerSave.setUserProfile(seekerProfile.get());
      } else {
